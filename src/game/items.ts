...
export const ITEMS: readonly ItemDef[] = [
  ...
  r('tide_pearl', 'Tide Pearl', 'shell', 'Tidemother’s gift. Hold it to your ear and the sea holds still.', 5),
  r('ember_core', 'Ember Core', 'ore', 'A heart of Emberjaw’s fire that never cools. Warm to hold on the coldest night.', 5),
  r('rime_horn', 'Rime Horn', 'bone', 'A curl of Rimebrow’s horn, clear as lake ice and harder than steel.', 5),
  r('choir_bell', 'Choir Bell', 'songstone', 'One of Old Croak’s little bells. It rings a note no one else can hear.', 5),
  ...
  r('star_shard', 'Starmetal', 'songstone', 'Pale metal from a fallen star. Cold to the touch, and faintly humming.', 20),
