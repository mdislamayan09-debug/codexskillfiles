...
- **Building**: campfires, beds, chests, stations, farm plots, rain collectors,
  and timber foundations, walls, doorways, floors, roofs and stairs that snap
  to a grid. Floors and stairs are walkable; a roof keeps the rain off.
- **Wildlife**: grazing herds, skittish hares, territorial boars, crabs on the
  beaches and duskhounds that hunt at night. Aim for weak points.
...
- **Discovery**: a parchment map with fog of war, a compass that learns
  ...
  caches to search at the island's named places.
